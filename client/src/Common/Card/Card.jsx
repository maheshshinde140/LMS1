...
function Card({ title, author, description }) {
    return (
        <Link to={`#`} className='w-[320px] h-[400px] text-white border border-[#1d1b22]  bg-black hover:scale-[103%] transition-all  font-inter  overflow-hidden mt-2   rounded-xl'>
            <img className='w-[320px] h-[190px]' alt='course' src={`https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/https://d15cw65ipctsrr.cloudfront.net/41/4d3d7c05fb42729c9d90352e072ca3/1060x596_GCC-photos_Karrim.png?auto=format%2Ccompress%2C%20enhance&dpr=1&w=320&h=180&fit=crop&q=50&crop=faces `} />
            <section className='flex my-2 w-[320px] flex-col gap-2 p-4'>
